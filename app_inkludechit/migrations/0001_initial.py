    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cm_batch_choices', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('cm_emi_tobe_paid', models.FloatField(blank=True, default=0.0, null=True)),
                ('cm_visit_type', models.CharField(blank=True, default='direct visit', max_length=100, null=True)),
