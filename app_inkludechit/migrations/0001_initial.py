# Generated by Django 5.2 on 2025-06-13 05:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('male', 'male'), ('female', 'female'), ('others', 'others')], default='male', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('other_agent_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='other_agent_data', to=settings.AUTH_USER_MODEL)),
                ('other_customer_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('other_customer_prof_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.customerprofilemodel')),
            ],
        ),
        migrations.CreateModel(
            name='PaidModel',
            fields=[
                ...
                ('paid_pay_type', models.CharField(blank=True, choices=[('fixed amount', 'fixed amount'), ('minimum required amount', 'minimum required amount')], max_length=100, null=True)),
                ('paid_next_pay_date', models.DateTimeField(blank=True, null=True)),
                ('paid_created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('paid_agent_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='paid_agent_data', to=settings.AUTH_USER_MODEL)),
                ('paid_customer_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('paid_customer_prof_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.customerprofilemodel')),
            ],
        ),
        migrations.CreateModel(
            name='SalePunchModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unpaid_reason', models.CharField(blank=True, max_length=255, null=True)),
                ('unpaid_pos_next_pend_pay', models.CharField(blank=True, choices=[('salary/income', 'salary/income'), ('anticipating money', 'anticipating money'), ('borrowed', 'borrowed'), ('money rolling', 'money rolling'), ('better financial profile', 'better financial profile')], max_length=100, null=True)),
                ('unpaid_res_date', models.DateTimeField(blank=True, null=True)),
                ('unpaid_created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('unpaid_agent_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='unpaid_agent_data', to=settings.AUTH_USER_MODEL)),
                ('unpaid_customer_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('unpaid_customer_prof_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.customerprofilemodel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cm_kyc', models.CharField(blank=True, max_length=12, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='KYC number should be 12 digit', regex='^\\d{12}')])),
                ('cm_uid', models.CharField(blank=True, max_length=12, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='UID number should be 12 digit', regex='^\\d{12}')])),
                ('cm_first_name', models.CharField(blank=True, max_length=255, null=True)),
                ('cm_last_name', models.CharField(blank=True, max_length=255, null=True)),
                ('cm_group', models.PositiveIntegerField(blank=True, choices=[('301', '301'), ('801', '801'), ('201', '201'), ('202', '202'), ('901', '901'), ('902', '902'), ('903', '903'), ('904', '904'), ('951', '951'), ('952', '952'), ('502', '502')], default='301', null=True)),
                ('cm_batch', models.CharField(blank=True, choices=[('1st', '1st'), ('2nd', '2nd'), ('3rd', '3rd'), ('4th', '4th'), ('5th', '5th')], max_length=10, null=True)),
                ...
                ('cm_collection_mode', models.CharField(blank=True, choices=[('daily', 'daily'), ('weekly', 'weekly'), ('monthly', 'monthly')], default='daily', null=True)),
                ('cm_payment_mode', models.CharField(blank=True, choices=[('gpay', 'gpay'), ('direct', 'direct')], default='gpay', null=True)),
                ('cm_emi_tobe_paid', models.FloatField(blank=True, choices=[('by call', 'by call'), ('by visit', 'by visit')], default=0.0, null=True)),
                ('cm_visit_type', models.CharField(blank=True, choices=[('direct visit', 'direct visit'), ('phone', 'phone')], default='direct visit', max_length=100, null=True)),
                ('cm_visit_count', models.PositiveIntegerField(blank=True, default=0, null=True)),
                ('cm_created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('cm_agent_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cm_agent_data', to=settings.AUTH_USER_MODEL)),
                ('cm_customer_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('cm_customer_prof_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.customerprofilemodel')),
                ('cm_others_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.othermodel')),
                ('cm_paid_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.paidmodel')),
                ('cm_salepunch_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.salepunchmodel')),
                ('cm_unpaid_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_inkludechit.unpaidmodel')),
            ],
        ),
    ]
